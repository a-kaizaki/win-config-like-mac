...
define_keymap(re.compile("dde-file-manager", re.IGNORECASE),{
    ...
    K("RC-Shift-Backslash"):   K("C-Shift-Tab"),           # Go to prior tab
    K("RC-Shift-Backslash"):  K("C-Tab"),                 # Go to next tab
...
define_keymap(re.compile("spacefm", re.IGNORECASE),{
    ...
    K("RC-Shift-Right_Brace"):   K("C-Shift-Tab"),           # Go to prior tab
    K("RC-Shift-Backslash"):  K("C-Tab"),                 # Go to next tab
    K("RC-Shift-Left"):         K("C-Shift-Tab"),           # Go to prior tab
    K("RC-Shift-Right"):        K("C-Tab"),                 # Go to next tab
...
define_keymap(re.compile(filemanagerStr, re.IGNORECASE),{
    ...
    K("RC-Shift-Right_Brace"):   K("C-Page_Up"),     # Go to prior tab
    K("RC-Shift-Backslash"):  K("C-Page_Down"),   # Go to next tab
...
define_keymap(re.compile("org.gnome.Console|Kgx|deepin-terminal|Angry*IP*Scanner|jDownloader", re.IGNORECASE),{
    ### Tab navigation
    K("RC-Shift-Right_Brace"):   K("C-Shift-Tab"),       # Tab nav: Go to prior tab (left)
    K("RC-Shift-Backslash"):  K("C-Tab"),             # Tab nav: Go to next tab (right)
...
define_keymap(lambda wm_class: wm_class.casefold() not in remotes,{
    K("RC-Shift-Right_Brace"):   K("C-Page_Up"),         # Tab nav: Go to prior (left) tab
    K("RC-Shift-Backslash"):  K("C-Page_Down"),       # Tab nav: Go to next (right) tab
...
define_keymap(re.compile(codeStr, re.IGNORECASE),{
    ...
    K("RC-Shift-Right_Brace"):   K("C-PAGE_UP"),             # next_view
    K("RC-Shift-Backslash"):  K("C-PAGE_DOWN"),           # prev_view
...
define_keymap(re.compile(termStr, re.IGNORECASE),{
    ...
    K("RC-Shift-Right_Brace"):   K("C-Page_Up"),     # Go to prior tab (Left)
    K("RC-Shift-Backslash"):  K("C-Page_Down"),   # Go to next tab (Right)
    K("RC-A"): K("C-Shift-A"),
    K("RC-S"): K("C-Shift-S"),
    K("RC-D"): K("C-Shift-D"),
    K("RC-F"): K("C-Shift-F"),
